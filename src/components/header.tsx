    ...
    <div className="flex flex-row items-center justify-evenly ">
      ...
      <div className="flex flex-row gap-4">
        <Link href={"/apply"} passHref>
          <button className="rounded-xl border border-black bg-black px-4 py-2 text-sm text-white transition duration-200 hover:shadow-[4px_4px_0px_0px_rgba(0,0,0)]"></button>
        </Link>
        <Link href={"/apply"} passHref>
